...
export const KENNUNG: Record<string, (n: number) => string> = {
  ...
  sv: n => (n > 1 ? 'En snabb upplysning: rösterna ni hör är skapade med AI.' : 'En snabb upplysning: rösten ni hör är skapad med AI.'),
...
export const PROBE_HINWEIS: Record<string, string> = {
  de: 'Eine Hörprobe von Klarframe Radio.', es: 'Una muestra de Klarframe Radio.', en: 'A sample from Klarframe Radio.', ca: 'Una mostra de Klarframe Radio.', sv: 'Ett smakprov från Klarframe Radio.',
}
